export default {
  ...
  format: {
    ...
    json: {
      ...
      compressError: 'JSON压缩失败，请检查数据格式',
      ...
      json5Title: 'JSON5 格式化',
      json5Placeholder: '请输入JSON5数据（支持注释、无引号键、尾逗号）',
      json5InfoTitle: '关于 JSON5 格式',
      json5Tip1: '格式化后键的双引号可能被去除（JSON5 允许无引号键）',
      json5Tip2: '短对象可能保持单行不换行，不影响数据正确性',
      json5Tip3: '注释完整保留，JSON5 相比标准 JSON 的主要优势就在于此',
      info: {
        title: '功能说明',
  ...
  convert: {
    ...
    color: {
      ...
      paletteMode: '方案类型',
      paletteModeComp: '互补色',
      paletteModeTriad: '三角色',
      paletteModeAnalog: '类似色',
      paletteModeShades: '明暗变体',
      paletteModeMonochrome: '单色系',
      paletteModeSquare: '四角色',
      paletteCount: '颜色数量',
      paletteGenerate: '生成方案',
      paletteCopyAll: '复制全部 HEX',
      paletteCopied: '已复制',
      paletteExportCss: '导出为 CSS 变量',
      paletteInfoTitle: '使用说明',
      paletteInfoContent: '选择基准颜色并选择配色类型，点击"生成方案"获得一组和谐配色。互补色：色相差180°；三角色：色相间隔120°；类似色：相邻色相；明暗变体：同色相不同明度；单色系：同色系不同饱和度/明度；四角色：色相间隔90°。点击色块可复制 HEX 值。'
    },
    regex: {
      title: '正则表达式',
    ...
    jsonConvert: {
      title: 'JSON 格式互转',
      description: 'JSON 与 YAML / CSV / TOML / XML 相互转换，支持生成 TypeScript / Go / Rust 代码',
      inputFormat: '输入格式',
      outputFormat: '输出格式',
      input: '输入',
      output: '输出',
      ...
      formatsDesc: '支持 JSON、YAML、CSV（对象数组）、TOML、XML 格式之间的相互转换。TypeScript / Go / Rust 代码生成仅支持 JSON 输入。',
      codeGenTitle: '代码结构生成',
      codeGenDesc: '根据 JSON 数据结构自动推断并生成对应语言的类型定义，可直接复制到项目中使用。'
    },
    numberChinese: {
      title: '数字大写转换',
    ...
    csvViewer: {
      title: 'CSV / TSV 预览解析',
      description: '粘贴或上传 CSV/TSV 文件，自动解析为表格，支持搜索、排序、导出 JSON',
      tabPaste: '粘贴文本',
      tabUpload: '上传文件',
      pastePlaceholder: '粘贴 CSV 或 TSV 内容...',
      uploadHint: '拖拽或点击上传 CSV / TSV 文件',
      uploadLimit: '最大 5MB',
delimiter: '分隔符',
delimAuto: '自动检测',
delimComma: '逗号 (,)',
...
hasHeader: '首行为表头',
      ...
      infoTitle: '使用说明',
      infoContent: '支持 CSV（逗号）、TSV（Tab）、分号、管道符分隔格式，可自动检测分隔符。点击列标题可排序；支持全文搜索过滤；可导出为 JSON 数组或重新下载为标准 CSV。所有处理在浏览器本地完成。'
    },
    cidr: {
      title: 'IP / CIDR 子网计算器',
      description: '输入 CIDR 或 IP+子网掩码，实时计算网络地址、广播地址、可用主机数等',
      inputMode: '输入方式',
      modeCidr: 'CIDR 表示法',
      modeMask: 'IP + 子网掩码',
      cidrPlaceholder: '如 192.168.1.0/24',
      ipPlaceholder: '如 192.168.1.0',
      maskPlaceholder: '如 255.255.255.0',
      calculate: '计算',
      resultTitle: '计算结果',
      networkAddr: '网络地址',
      broadcastAddr: '广播地址',
      ...
      quickRefHosts: '可用主机数',
      quickRefMask: '子网掩码',
      invalidInput: '请输入有效的 IPv4 地址',
      invalidCidr: '请输入有效的 CIDR（如 192.168.1.0/24）',
      invalidMask: '请输入有效的子网掩码',
      infoTitle: '使用说明',
      infoContent: '支持 CIDR 表示法（如 192.168.1.0/24）和 IP+子网掩码两种输入方式。仅支持 IPv4，子网前缀范围 /0 ~ /32。点击速查表中的行可直接填入计算。上次输入会自动记忆。'
    },
    jsonSchema: {
      title: 'JSON Schema 生成器',
      description: '粘贴 JSON 数据，自动推断并生成 JSON Schema (draft-07) 或 TypeScript Interface',
      ...
      copy: '复制',
      copied: '已复制',
      schemaTitle: 'Schema 标题',
      schemaTitlePlaceholder: '如 MySchema（可选）',
      allRequired: '所有字段标记为 required',
      invalidJson: 'JSON 格式不正确',
      infoTitle: '使用说明',
      infoContent: '粘贴任意 JSON（对象或数组），自动推断字段类型并生成标准 JSON Schema draft-07 或 TypeScript Interface。数组类型取所有元素的并集推断。可选择是否将所有顶层字段设为 required。'
    }
  },
  image: {
    convert: {
      ...
      resizeWidth: '宽度',
      resizeHeight: '高度',
      resizeLockRatio: '锁定宽高比',
      resizePixelUnit: 'px',
      resizePercentUnit: '%',
      resizeOriginalSize: '原始尺寸',
      resizeTargetSize: '目标尺寸',
      infoTitle: '使用说明',
      infoContent: '有损格式 (JPEG / WebP): 体积小，适合照片，可调整质量 10%~100%。无损格式 (PNG / GIF): 完美保留所有细节，体积较大。尺寸调整支持按像素或百分比缩放，锁定宽高比可防止变形。所有处理均在浏览器本地完成，图片不会上传到服务器。'
    },
    rotate: {
      title: '图片旋转',
  ...
  text: {
    ...
    stats: {
      title: '文本统计分析',
      description: '实时统计字符数、单词数、行数、字节大小、中英文分布等，并提供词频统计和字符分布图表',
      placeholder: '请输入或粘贴要分析的文本...',
      charTotal: '字符数（含空格）',
      charNoSpace: '字符数（不含空格）',
      wordCount: '单词数',
      lineCount: '行数',
      paraCount: '段落数',
      byteSize: '字节大小 (UTF-8)',
      ...
      distSpace: '空白',
      infoTitle: '使用说明',
      infoContent: '实时分析输入的文本，无需点击任何按钮。中文阅读速度按 500 字/分钟估算，英文按 200 词/分钟估算。词频统计展示 Top 20 高频词（中文逐字统计，英文按单词）。'
    }
  },
  other: {
    qrcode: {
    ...
    httpClient: {
      title: 'HTTP 请求测试',
      description: '在线发送 HTTP/HTTPS 请求，支持 GET/POST/PUT/PATCH/DELETE 等方法，可设置自定义 Headers、Query Params 和 Body',
      urlPlaceholder: '请输入请求地址，如 https://api.example.com/users',
      send: '发送',
      params: 'Params',
      headers: 'Headers',
      body: 'Body',
      bodyNone: 'None',
      bodyTextPlaceholder: '请输入请求体内容',
      addParam: '添加参数',
      addHeader: '添加请求头',
      addField: '添加字段',
      key: 'Key',
      ...
      respHeaders: '响应头',
      requestFailed: '请求失败',
      corsHint: '跨域（CORS）限制：目标服务器未允许浏览器直接访问。可尝试使用支持 CORS 的 API 接口，或在服务器端开启跨域。',
      urlRequired: '请输入请求地址',
      unknownError: '未知错误',
      noteTitle: '使用说明',
      noteContent: '本工具直接在浏览器中发送请求，受浏览器 CORS 策略限制，部分接口可能无法直接访问。适合测试开放 API 或已配置 CORS 的接口。'
    },
    certParser: {
      title: 'SSL 证书解析',
      description: '解析 SSL/TLS X.509 证书，查看主体、颁发者、有效期、SAN、指纹等详细信息',
      pasteMode: '粘贴 / 上传 PEM',
      uploadFile: '上传证书文件（.pem / .crt / .cer）',
      domainMode: '域名查询',
      pemPlaceholder: '粘贴 PEM 格式证书，以 -----BEGIN CERTIFICATE----- 开头',
      domainPlaceholder: '输入域名，如 github.com',
      fetch: '查询',
      parse: '解析证书',
      subject: '主体（Subject）',
      issuer: '颁发者（Issuer）',
      ...
      keyUsage: '密钥用途',
      extKeyUsage: '扩展密钥用途',
      thumbprintSha1: 'SHA-1 指纹',
      thumbprintSha256: 'SHA-256 指纹',
      expired: '证书已过期',
      expireSoon: '证书即将过期（剩余 {days} 天）',
      validFor: '证书有效（剩余 {days} 天）',
      parseError: '证书解析失败',
      fetchError: '查询失败',
      fetchFailedTitle: '域名查询失败',
      fetchTimeout: 'crt.sh 请求超时（国内网络访问可能不稳定），请使用以下命令手动获取证书后粘贴到「粘贴 PEM」：',
      fetchNetworkError: 'crt.sh 网络不可用（国内访问受限），请使用以下命令手动获取证书后粘贴到「粘贴 PEM」：',
      opensslHint: '在终端运行以下命令获取 PEM，然后粘贴到左侧「粘贴 PEM」模式：',
      noResult: '未找到该域名的证书记录',
      domainRequired: '请输入域名',
      noteTitle: '使用说明',
      noteContent: '粘贴模式支持 PEM 格式（-----BEGIN CERTIFICATE-----）；域名查询通过 crt.sh 公共 CT 日志获取最新证书，国内网络可能不稳定，此时可用 openssl 命令手动提取证书。'
    },
    promptBox: {
      title: 'Prompt 工具箱',
      description: '内置常用 Prompt 模板，支持变量填充、自定义管理',
      searchPlaceholder: '搜索 Prompt...',
      addPrompt: '新增 Prompt',
      noResult: '未找到匹配的 Prompt',
      stats: '共 {total} 条（内置 {builtin} / 自定义 {custom}）',
      catAll: '全部',
      catCode: '代码',
      catWriting: '写作',
      catAnalysis: '分析',
      ...
      catCustom: '自定义',
      fillVars: '填充变量',
      fillVarsTitle: '填充变量并复制',
      promptContent: 'Prompt 内容预览',
      varPlaceholder: '请输入 {name}',
      copyFilled: '复制填充结果',
      copied: '已复制到剪贴板',
      editTitle: '编辑 Prompt',
      addTitle: '新增 Prompt',
      ...
      fieldCategory: '分类',
      fieldDesc: '简介',
      fieldContent: 'Prompt 内容',
      titlePlaceholder: '请输入 Prompt 名称',
      descPlaceholder: '简短描述（可选）',
      contentPlaceholder: '请输入 Prompt 内容，用双花括号变量（如 language、code）表示可替换内容，点击「填充变量」即可交互填入',
      titleRequired: '请输入名称',
    ...
    gitCommit: {
      ...
      description: '遵循 Conventional Commits 规范，表单式填写自动生成规范 commit 信息',
      type: '提交类型',
      scope: '影响范围',
      scopePlaceholder: '如: auth / ui / api（可选）',
      subject: '简短描述',
      subjectPlaceholder: '简短描述本次提交，不超过 72 字符',
      subjectTooLong: '描述超过 72 字符',
      body: '详细描述',
      bodyPlaceholder: '可详细描述变更原因和内容（可选，支持多行）',
      breaking: '破坏性变更 (BREAKING CHANGE)',
      breakingDesc: '破坏性变更说明',
      breakingDescPlaceholder: '描述破坏性变更的内容（如迁移步骤）',
      issues: '关联 Issue',
      issuesPlaceholder: '如: #123, #456（可选）',
      preview: 'Commit 预览',
      previewEmpty: '填写提交类型和简短描述后自动生成...',
      copyFull: '复制完整 Commit',
      copyTitle: '仅复制标题行',
      copied: '已复制到剪贴板',
      history: '最近提交记录',
      infoTitle: '使用说明',
infoContent: '遵循 Conventional Commits 规范：type(scope): subject。feat=新功能, fix=修复Bug, docs=文档, style=格式, refactor=重构, perf=性能, test=测试, chore=构建/辅助。破坏性变更会在 type 后追加 ! 标识。',
typeFeatDesc: '新功能',
typeFixDesc: '修复 Bug',
typeDocsDesc: '文档更新',
typeStyleDesc: '代码格式（不影响功能）',
typeRefactorDesc: '代码重构（非 Bug 修复/新功能）',
typePerfDesc: '性能优化',
typeTestDesc: '添加测试',
typeChoreDesc: '构建/辅助工具变更',
typeRevertDesc: '回退提交',
typeBuildDesc: '构建系统 / 外部依赖',
typeCiDesc: 'CI 配置变更'
},
    mockData: {
      title: 'Mock 数据生成器',
      description: '通过可视化字段配置，快速生成符合业务结构的 JSON 模拟数据',
      count: '生成条数',
      addField: '添加字段',
      generate: '生成',
      copy: '复制',
      ...
      fieldType: '类型',
      fieldOptions: '选项',
      fieldNamePlaceholder: '如 id / name / email',
      typeInt: '整数',
      typeFloat: '浮点数',
      typeString: '随机字符串',
      typeName: '姓名',
      ...
      arrayItemType: '元素类型',
      addChild: '添加子字段',
      enumOptions: '枚举值（逗号分隔）',
      enumPlaceholder: '如 active,inactive,pending',
      customTemplate: '模板',
      customPlaceholder: '如 user_{index}',
      intMin: '最小值',
      intMax: '最大值',
      floatDecimal: '小数位数',
      resultTitle: '生成结果',
      emptyFields: '请添加至少一个字段',
      infoTitle: '使用说明',
      infoContent: '添加字段并选择类型，支持嵌套 Object（子字段）和 Array（数组）。枚举类型支持自定义选项列表；自定义模板支持 {index}（从1起）、{uuid}、{timestamp} 占位符。Object/Array 字段点击 ▼ 可折叠，点击「添加子字段」可嵌套。支持导出为 JSON 文件。'
    }
  },
  custom: {
    title: '自定义',
    scriptBox: {
      title: '脚本工具箱',
      description: '写一个 JavaScript 函数，输入数据运行就得到结果。支持导入/导出脚本集',
      myScripts: '我的脚本',
      newScript: '新建脚本',
      noScripts: '还没有脚本',
      selectOrCreate: '选择一个脚本，或新建一个',
      scriptCode: '脚本代码',
      inputData: '输入数据',
      inputPlaceholder: '输入内容，将作为 input 参数传入函数（可为空）',
      run: '运行',
      output: '输出',
      outputEmpty: '点击「运行」查看结果',
      runTime: '耗时 {ms}ms',
      deleteConfirm: '确认删除这个脚本？',
      export: '导出脚本集',
      import: '导入脚本集',
      exportSuccess: '导出成功',
      importSuccess: '导入成功，共 {count} 个脚本',
      ...
      descPlaceholder: '简短描述（可选）',
      nameRequired: '请输入名称',
      localStorageHint: '脚本保存在浏览器本地存储中，清除 Cookie / 浏览器数据后将丢失，建议定期导出备份',
      codeHint1: '函数必须命名为 transform，接收 input 和 helpers 两个参数：',
      codeHint2: '返回字符串、对象或任意值，支持 async/await',
      helpersRef: '可用 helpers 参考',
      helperDayjs: '时间格式化和计算',
      helperLodash: 'lodash-es 全量方法',
      helperCryptoJS: 'MD5 / AES / SHA / HMAC 等强加密算法',
      helperYaml: 'YAML 解析与序列化',
      helperMath: 'mathjs 数学计算库',
      helperUuid: '生成 UUID v4',
      helperNanoid: '生成 NanoID',
      helperDiff: '文本 diff 对比',
      helperMarked: 'Markdown 转 HTML',
      helperDOMPurify: 'XSS 内容过滤',
      helperXml: 'XML 解析器',
      helperSparkMD5: '大文件 MD5 哈希',
      helperBuiltin: '浏览器原生 API，无需导入',
      helperCrypto: 'Web Crypto API，SHA/AES 加解密',
      cat_text: '文本',
      cat_json: 'JSON',
      cat_crypto: '加密',
      cat_datetime: '时间',
      cat_network: '网络',
      cat_util: '工具',
      errorNoTransform: '未找到 transform 函数，请确保代码中包含命名函数 transform'
    }
  },
  composer: {
    title: '组件编排',
