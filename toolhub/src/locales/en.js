  ...
  privacy: {
    ...
    sections: {
      collection: {
        ...
        usage: {
          title: 'Usage Data',
          desc: 'Anonymous statistical information such as tool pages you visit and usage frequency'
        },
        technical: {
          title: 'Technical Information',
          desc: 'Basic technical information such as browser type, operating system, IP address'
        },
        cookies: {
          title: 'Cookies',
          desc: 'Necessary cookies used to improve user experience'
        }
      },
      usage: {
        title: '2. Information Usage',
        intro: 'We use the collected information for:',
        provide: 'Providing and maintaining our services',
        improve: 'Improving user experience and website functionality',
        analyze: 'Analyzing website usage to optimize performance',
        security: 'Ensuring website security and preventing abuse'
      },
      processing: {
        title: '3. Data Processing',
        important: 'Important Note',
        description: 'All data you input in our tools (such as code to be formatted, text to be encrypted, etc.) is processed locally in your browser and is not uploaded to our servers.',
        local: 'All tool operations are executed on the client side',
        noLeave: 'Your sensitive data never leaves your device',
        noAccess: 'We cannot access your input content'
      },
      thirdParty: {
        ...
        analytics: {
          ...
          desc: 'Used for website access statistics and analysis'
        },
        adsense: {
          title: 'Google AdSense',
          desc: 'Used to display relevant advertisements'
        },
        cdn: {
          title: 'CDN Services',
          desc: 'Used to improve website loading speed'
        },
        disclaimer: 'These services have their own privacy policies, and we recommend that you review the relevant terms.'
      },
      security: {
        title: '5. Data Security',
        intro: 'We take reasonable technical and administrative measures to protect your personal information:',
        https: 'Using HTTPS encrypted transmission',
        audit: 'Regular security reviews and updates',
        access: 'Access control and permission management',
        backup: 'Data backup and recovery mechanisms'
      },
      rights: {
        title: '6. Your Rights',
        intro: 'You have the right to:',
        know: 'Know how we collect and process your personal information',
        correct: 'Request correction or deletion of your personal information',
        restrict: 'Refuse or restrict certain data processing activities',
  ...
  terms: {
    ...
    sections: {
      intro: {
        ...
        welcome: 'Welcome to ToolHub (hereinafter referred to as "this service"). ToolHub is a free online developer tools collection providing code formatting, data conversion, encryption/decryption, image processing and various practical tools.',
      ...
      usage: {
        ...
        freeUse: {
          title: '2.1 Free Usage',
          intro: 'ToolHub provides online tool services to users for free. You can:',
          tools: 'Use all provided development tools',
          features: 'Enjoy complete tool functionality',
          local: 'Process your data in local browser',
          noRegistration: 'Use most features without registration'
        },
        limitations: {
          title: '2.2 Usage Limitations',
          intro: 'To maintain service quality, we may restrict the following behaviors:',
          excessive: 'Excessively frequent requests (beyond reasonable usage)',
          attack: 'Attempts to destroy or attack the website',
          automation: 'Using automated scripts for massive access',
          interference: 'Any behavior that may affect other users\' normal usage'
        }
      },
      responsibility: {
        title: '3. User Responsibilities',
        legal: {
          title: '3.1 Legal Usage',
          intro: 'You promise to:',
          lawful: 'Use this service only for legal purposes',
          noHarm: 'Not use this service to process illegal, harmful or inappropriate content',
          noAccess: 'Not attempt to access other users\' data or damage system security',
          comply: 'Comply with local laws and regulations and these terms of service'
        },
        data: {
          title: '3.2 Data Responsibility',
          reminder: 'Important reminder:',
          backup: 'Please backup important data yourself, we are not responsible for data loss',
          sensitive: 'Do not input extremely sensitive or confidential information in tools',
          risk: 'Although data is processed locally, network transmission still has risks',
          localBackup: 'It is recommended to backup important data locally first'
        }
      },
      intellectualProperty: {
        title: '4. Intellectual Property',
        intro: 'All content of this website, including but not limited to:',
        design: 'Website design, layout and user interface',
        code: 'Source code and algorithm implementation',
        content: 'Text content and documentation',
        brand: 'Trademarks, logos and brand elements',
        disclaimer: 'are owned by ToolHub or used under authorization. Users may not copy, distribute or use for commercial purposes without permission.'
      },
      serviceChanges: {
        title: '5. Service Changes and Interruptions',
        updates: {
          title: '5.1 Service Updates',
          intro: 'We reserve the right to modify, update or improve the service at any time:',
          tools: 'Add new tools and features',
          performance: 'Improve the performance of existing tools',
          interface: 'Adjust user interface and experience',
          bugs: 'Fix bugs and security issues'
        },
        interruption: {
          title: '5.2 Service Interruption',
          intro: 'The following situations may cause temporary service interruption:',
          maintenance: 'System maintenance and upgrades',
          technical: 'Technical failures or network problems',
          force: 'Force majeure factors',
          legal: 'Legal and regulatory requirements'
        }
      },
      disclaimer: {
        title: '6. Disclaimer',
        intro: 'This service is provided "as is", and we are not responsible for:',
        accuracy: 'Accuracy of tool processing results (please verify yourself)',
        availability: 'Continuity and availability of service',
        damages: 'Any direct or indirect losses caused by using this service',
        thirdParty: 'Third-party services or linked content',
        suggestion: 'Suggestion: For important production environments, please fully test before using tool results.'
      },
      privacy: {
        title: '7. Privacy Protection',
        intro: 'We highly value your privacy protection:',
        local: 'Most tools run locally in your browser',
        noCollection: 'We do not actively collect your tool usage data',
        policy: 'For details, please see our',
      ...
      contact: {
        ...
        email: 'Email: support@toolhub.com',
        address: 'Address: Beijing, China',
        response: 'We will reply as soon as possible after receiving your inquiry.'
      }
    }
  },

  // About Us related text
  about: {
    title: 'About ToolHub',
    seo: {
    ...
    sections: {
      mission: {
        title: 'Our Mission',
        description: 'ToolHub is committed to providing developers and technical workers with simple, fast, and secure online tool collections. We believe that good tools can improve work efficiency and make technical work easier and more enjoyable.',
        highlights: {
          developer: {
            title: 'Developer Friendly',
            desc: 'Designed specifically for developers, supporting various programming languages and data formats'
          },
          privacy: {
            title: 'Privacy Protection',
            desc: 'Most tools run locally in browser, ensuring data security'
          },
          fast: {
            title: 'Fast & Convenient',
            desc: 'No download or installation required, just open browser to use'
          }
        }
      },
      features: {
        ...
        categories: {
          format: {
            ...
            desc: 'Support beautification and compression of JSON, XML, YAML, JavaScript, HTML, CSS, SQL and other formats',
            features: {
              highlight: 'Smart syntax highlighting',
              error: 'Error detection and prompts',
              indent: 'Custom indentation and styles',
              copy: 'One-click copy and download'
            }
          },
          encrypt: {
            title: '🔐 Encryption & Decryption',
            desc: 'Provide various encryption algorithms and encoding methods to meet different security needs',
            features: {
              symmetric: 'Symmetric encryption: AES, DES, ChaCha20',
              asymmetric: 'Asymmetric encryption: RSA, ECC',
              hash: 'Hash algorithms: SHA, MD5, Argon2',
              encoding: 'Encoding conversion: Base64, Hex, URL'
            }
          },
          convert: {
            title: '🔄 Data Conversion',
            desc: 'Conversion and calculation tools between various data formats',
            features: {
              timestamp: 'Timestamp conversion and calculation',
          ...
          image: {
            title: '🖼️ Image Tools',
            desc: 'Basic image processing and editing functions',
            features: {
              format: 'Format conversion',
              resize: 'Size adjustment and cropping',
              rotate: 'Rotation and flipping',
              watermark: 'Watermark addition'
            }
          },
          text: {
            title: '📝 Text Tools',
            desc: 'Text processing and editing related tools',
            features: {
              case: 'Case conversion',
              replace: 'Find and replace',
              whitespace: 'Whitespace character processing',
              reverse: 'Text reversal and sorting'
            }
          },
          other: {
            title: '🔍 Other Tools',
            desc: 'Practical auxiliary tools and calculators',
            features: {
...
emailRegex.test('user@example.com') // true`
      ...
      qrCodeTech: {
        title: 'QR Code Generation Technology and Applications',
        summary: 'QR codes are ubiquitous in modern life. Understanding the generation principles and technical implementation of QR codes can help developers better integrate QR code functionality into projects.',
        highlights: {
          0: 'QR Code encoding principles',
          1: 'Error correction mechanisms',
          2: 'Capacity and density optimization',
          3: 'Style customization techniques'
        },
...
const qrSVG = await QRCode.toString('Hello World', { type: 'svg' })`
      ...
      codeFormatting: {
        title: 'Code Formatting Tool Selection and Configuration',
        summary: 'Good code formatting not only improves code readability but also reduces conflicts in team collaboration. This article introduces the characteristics and configuration methods of various code formatting tools.',
        highlights: {
          0: 'Comparison of mainstream formatting tools',
          1: 'Team coding standards formulation',
          2: 'Automated formatting configuration',
          3: 'IDE integration best practices'
        },
        codeExample: `// .prettierrc configuration example
{
  "semi": true,
  "trailingComma": "es5",
  "singleQuote": true,
...
// package.json scripts
{
  ...
  "lint": "eslint . --fix"
      ...
      imageOptimization: {
        title: 'Image Processing Optimization Strategies in Web',
        summary: 'Images are an important component of Web applications and a key factor affecting page performance. Mastering image processing and optimization techniques can significantly improve user experience.',
        highlights: {
          0: 'Image format selection guide',
          1: 'Compression algorithm and quality balance',
          2: 'Responsive image implementation',
          3: 'Lazy loading and preloading strategies'
        },
        codeExample: `// Canvas image processing example
