export default {
  ...
  format: {
    ...
    json: {
      ...
      compressError: 'JSON compression failed, please check data format',
      ...
      json5Title: 'JSON5 Formatter',
      json5Placeholder: 'Enter JSON5 data (supports comments, unquoted keys, trailing commas)',
      json5InfoTitle: 'About JSON5',
      json5Tip1: 'Keys may lose their double quotes after formatting (valid in JSON5)',
      json5Tip2: 'Short objects may stay on a single line — this does not affect correctness',
      json5Tip3: 'Comments are preserved — the main reason to use JSON5 over standard JSON',
      info: {
  ...
  encrypt: {
    ...
    ed25519Sign: {
      ...
      keyGenTime: 'Key Generation Time',
      signatureTime: 'Signature Time',
      verificationTime: 'Verification Time',
      securityNote: 'Security Note',
      securityDescription: 'Ed25519 is a high-performance elliptic curve digital signature algorithm based on Curve25519. It provides high security, short key lengths, and fast signature verification, making it one of the preferred algorithms in modern cryptography.'
    },
    sha: {
    ...
    argon2: {
      ...
      bytes: 'bytes',
      securityNote: 'Security Note',
      securityDescription: 'PBKDF2 is a password-based key derivation function that increases computational cost through multiple iterations, effectively resisting brute force attacks'
    },
    'ecdh-key-exchange': {
      ...
      keyGenTime: 'Key Generation Time',
      exchangeTime: 'Exchange Compute Time',
      exchanged: 'Exchanged',
      notExchanged: 'Not Exchanged',
      securityNote: 'Security Note',
      securityDescription: 'ECDH provides perfect forward secrecy, ensuring previous communications remain secure even if private keys are compromised'
    },
    x25519: {
      ...
      notExchanged: 'Not Exchanged',
      securityNote: 'Security Note',
      securityDescription: 'X25519 is based on Curve25519, providing high-performance key exchange widely used in modern cryptographic protocols'
    },
    'rsa-sign': {
      title: 'RSA Signature',
    ...
    rsaSign: {
      ...
      verificationTime: 'Verification Time',
      securityNote: 'Security Note',
      securityDescription: 'RSA signatures provide digital authentication and integrity protection. Key length affects security. 1024-bit keys are insecure, recommend using 2048-bit or higher.'
    },
    'ecdsa-sign': {
    ...
    ecdsaSign: {
      ...
      verificationTime: 'Verification Time',
      securityNote: 'Security Note',
      securityDescription: 'ECDSA signatures are based on elliptic curve cryptography, providing high security with short key lengths. Both P-256 and P-384 curves offer sufficient security for modern applications.'
    },
    'ed25519-sign': {
      title: 'Ed25519 Signature',
      description: 'Ed25519 digital signature algorithm'
  ...
  convert: {
    ...
    color: {
      ...
      paletteInput: 'Base Color',
      paletteMode: 'Scheme Type',
      paletteModeComp: 'Complementary',
      paletteModeTriad: 'Triadic',
      paletteModeAnalog: 'Analogous',
      paletteModeShades: 'Shades',
      paletteModeMonochrome: 'Monochromatic',
      paletteModeSquare: 'Square',
      paletteCount: 'Color Count',
      paletteGenerate: 'Generate',
      paletteCopyAll: 'Copy All HEX',
      paletteCopied: 'Copied',
      paletteExportCss: 'Export as CSS Variables',
      paletteInfoTitle: 'Usage Guide',
      paletteInfoContent: 'Pick a base color and scheme type, then click Generate. Complementary: 180° apart; Triadic: 120° intervals; Analogous: adjacent hues; Shades: same hue, varying lightness; Monochromatic: same hue family; Square: 90° intervals. Click a swatch to copy its HEX value.'
    },
    regex: {
    ...
    diff: {
      title: 'Diff Text Comparison',
      description: 'Compare texts with line-level, character-level, or word-level diff',
      mode: 'Diff Mode',
      lineMode: 'Line diff',
      charMode: 'Character diff',
      wordMode: 'Word diff',
      original: 'Original',
      modified: 'Modified',
    ...
    cron: {
      ...
      description: 'Parse Cron expressions, show human-readable description and next execution times',
      expression: 'Cron Expression',
      placeholder: 'e.g. 0 3 * * *',
      invalidExpr: 'Invalid expression',
      parseError: 'Parse failed, please check the expression',
      nextTimes: 'Next 5 Execution Times',
      ...
      fieldGuideContent: 'Standard Cron (5 fields): minute hour day month weekday. Ranges: min(0-59), hour(0-23), day(1-31), month(1-12), weekday(0-6, 0=Sunday). Wildcards: * any, / step, - range, , list',
      everyMinute: 'Every minute',
      every5Minutes: 'Every 5 minutes',
      everyHour: 'Every hour',
      everyDayAt3: 'Every day at 3:00',
      everyMonday9: 'Every Monday at 9:00',
      firstDayOfMonth: 'First day of month',
      newYear: "New Year's Day",
      weekdaysAt18_30: 'Weekdays at 18:30'
    },
    jsonConvert: {
      title: 'JSON Format Converter',
      description: 'Convert between JSON, YAML, CSV, TOML and XML formats, generate TypeScript / Go / Rust code',
      ...
      formatsDesc: 'Supports conversion between JSON, YAML, CSV (object arrays), TOML, and XML formats. TypeScript / Go / Rust code generation requires JSON input.',
      codeGenTitle: 'Code Structure Generation',
      codeGenDesc: 'Automatically infer and generate type definitions for the target language from the JSON data structure. Copy and use directly in your project.'
    },
    numberChinese: {
    ...
    csvViewer: {
      ...
      description: 'Paste or upload CSV/TSV files, parse into a table with search, sort, and JSON export',
      tabPaste: 'Paste Text',
      tabUpload: 'Upload File',
      pastePlaceholder: 'Paste CSV or TSV content here...',
      uploadHint: 'Drag or click to upload a CSV / TSV file',
      uploadLimit: 'Max 5MB',
delimiter: 'Delimiter',
...
hasHeader: 'First row is header',
      ...
      totalCols: '{n} columns',
      truncated: 'Showing first {n} rows only',
      search: 'Search...',
      exportJson: 'Export JSON',
      exportCsv: 'Download CSV',
      fileTooLarge: 'File exceeds the 5MB limit',
      infoTitle: 'Usage Guide',
      infoContent: 'Supports CSV (comma), TSV (tab), semicolon, and pipe-delimited formats with auto-detection. Click column headers to sort; use the search box to filter rows. Export as a JSON array or re-download as a standard CSV. All processing is done locally in your browser.'
    },
    cidr: {
      title: 'IP / CIDR Calculator',
      description: 'Enter CIDR notation or IP + subnet mask to calculate network address, broadcast, usable hosts, and more',
      inputMode: 'Input Mode',
      modeCidr: 'CIDR Notation',
      modeMask: 'IP + Subnet Mask',
      ...
      ipClass: 'IP Class / Type',
      cidrPrefix: 'CIDR Prefix',
      binaryTitle: 'Binary Representation',
      quickRef: 'Subnet Quick Reference',
      quickRefPrefix: 'Prefix',
      quickRefHosts: 'Usable Hosts',
      quickRefMask: 'Subnet Mask',
      invalidInput: 'Please enter a valid IPv4 address',
      invalidCidr: 'Please enter a valid CIDR (e.g. 192.168.1.0/24)',
      invalidMask: 'Please enter a valid subnet mask',
      infoTitle: 'Usage Guide',
      infoContent: 'Supports CIDR notation (e.g. 192.168.1.0/24) and IP + subnet mask input. IPv4 only, prefix range /0 ~ /32. Click a row in the quick reference table to auto-fill. Your last input is remembered.'
    },
    jsonSchema: {
      title: 'JSON Schema Generator',
      description: 'Paste JSON data to auto-generate JSON Schema (draft-07) or TypeScript Interface',
      ...
      schemaTitlePlaceholder: 'e.g. MySchema (optional)',
      allRequired: 'Mark all fields as required',
      invalidJson: 'Invalid JSON format',
      infoTitle: 'Usage Guide',
      infoContent: 'Paste any JSON (object or array) to auto-infer field types and generate a standard JSON Schema draft-07 or TypeScript Interface. Array types are inferred as the union of all element types. Optionally mark all top-level fields as required.'
    }
  },
  image: {
    convert: {
      ...
      resizeTitle: 'Resize',
      resizeMode: 'Scale Mode',
      resizeModeNone: 'No Resize',
      resizeModePixel: 'Pixel',
      resizeModePercent: 'Percent',
      resizeWidth: 'Width',
      resizeHeight: 'Height',
      resizeLockRatio: 'Lock Aspect Ratio',
      resizePixelUnit: 'px',
      resizePercentUnit: '%',
      resizeOriginalSize: 'Original Size',
      resizeTargetSize: 'Target Size',
      infoTitle: 'Usage Guide',
      infoContent: 'Lossy formats (JPEG / WebP): Smaller size, ideal for photos, quality adjustable 10%~100%. Lossless formats (PNG / GIF): Perfect detail preservation, larger file size. Resize supports pixel or percentage scaling; lock aspect ratio prevents distortion. All processing is done locally in your browser — images are never uploaded.'
    },
    rotate: {
      title: 'Image Rotate',
  ...
  text: {
    ...
    stats: {
      ...
      description: 'Real-time text analysis: characters, words, lines, byte size, Chinese/English distribution, word frequency and character distribution',
      placeholder: 'Type or paste text to analyze...',
      charTotal: 'Characters (with spaces)',
      charNoSpace: 'Characters (no spaces)',
      wordCount: 'Words',
      lineCount: 'Lines',
      paraCount: 'Paragraphs',
      byteSize: 'Byte Size (UTF-8)',
      chineseCount: 'Chinese Characters',
      englishCount: 'English Letters',
      digitCount: 'Digits',
      sentenceCount: 'Sentences',
      readMinutes: 'Est. Reading Time',
      tabFreq: 'Word Frequency',
      tabDist: 'Char Distribution',
      noWords: 'No valid words detected',
      distChinese: 'Chinese',
      distEnglish: 'English',
      distDigit: 'Digits',
      distPunct: 'Punctuation',
      distSpace: 'Whitespace',
      infoTitle: 'Usage Guide',
      infoContent: 'Analysis updates in real-time as you type. Chinese reading speed estimated at 500 chars/min, English at 200 words/min. Word frequency shows Top 20 terms (Chinese character-by-character, English word-by-word).'
    }
  },
  other: {
    qrcode: {
    ...
    ip: {
      title: 'IP Query',
      description: 'Look up your current IP or any IP for geolocation, ISP and more',
      currentIp: 'Current IP Info',
      refresh: 'Refresh',
      clickToLoad: 'Click refresh to load current IP info',
      queryAny: 'Query Any IP',
      queryPlaceholder: 'Enter IPv4 or IPv6 address, e.g. 8.8.8.8',
      query: 'Query',
      ...
      latlon: 'Lat / Lon',
      asn: 'ASN',
      fetchError: 'Query failed, please check your network connection',
      emptyInput: 'Please enter an IP address',
      apiNote: 'API Note',
      apiNoteContent: 'Uses ipapi.co (free, 1000/day). Falls back to ip-api.com on error.'
    },
    fileHash: {
      title: 'File Hash Checker',
      description: 'Compute MD5, SHA-1, SHA-256, SHA-512 hash of any file',
      dragOrClick: 'Drag file here, or click to upload',
      sizeHint: 'Any file type supported, recommended < 500MB',
      fileName: 'File Name',
      fileSize: 'File Size',
      fileType: 'File Type',
      lastModified: 'Last Modified',
      computing: 'Computing hash values...',
      hashResults: 'Hash Values',
      verify: 'Hash Verification',
      verifyPlaceholder: 'Paste expected hash value (MD5/SHA-1/SHA-256/SHA-512)',
      verifyBtn: 'Verify',
      match: 'Hash Matched ✓',
    ...
    dns: {
      title: 'DNS Lookup',
      description: 'Query DNS records for any domain (A/AAAA/MX/TXT/CNAME/NS/SOA)',
      domain: 'Domain',
      domainPlaceholder: 'Enter domain, e.g. github.com',
      query: 'Query',
    ...
    httpClient: {
      ...
      description: 'Send HTTP/HTTPS requests online, supports GET/POST/PUT/PATCH/DELETE methods with custom Headers, Query Params and Body',
      urlPlaceholder: 'Enter request URL, e.g. https://api.example.com/users',
      send: 'Send',
      params: 'Params',
      headers: 'Headers',
      body: 'Body',
      ...
      corsHint: 'CORS restriction: the target server does not allow browser direct access. Try using an API that supports CORS, or enable CORS on the server side.',
      urlRequired: 'Please enter a request URL',
      unknownError: 'Unknown error',
      noteTitle: 'Note',
      noteContent: 'This tool sends requests directly from the browser and is subject to browser CORS policies. Some APIs may not be accessible directly. Suitable for testing public APIs or APIs with CORS configured.'
    },
    certParser: {
      title: 'SSL Certificate Parser',
      description: 'Parse SSL/TLS X.509 certificates to view subject, issuer, validity, SAN, fingerprints and more',
      pasteMode: 'Paste / Upload PEM',
      uploadFile: 'Upload certificate file (.pem / .crt / .cer)',
      domainMode: 'Domain Lookup',
      pemPlaceholder: 'Paste PEM certificate starting with -----BEGIN CERTIFICATE-----',
      domainPlaceholder: 'Enter domain name, e.g. github.com',
      fetch: 'Fetch',
      ...
      thumbprintSha1: 'SHA-1 Thumbprint',
      thumbprintSha256: 'SHA-256 Thumbprint',
      expired: 'Certificate has expired',
      expireSoon: 'Certificate expires soon ({days} days remaining)',
      validFor: 'Certificate is valid ({days} days remaining)',
      parseError: 'Certificate parse failed',
      fetchError: 'Lookup failed',
      fetchFailedTitle: 'Domain Lookup Failed',
      fetchTimeout: 'crt.sh request timed out (may be unreachable in your region). Use the command below to fetch the certificate manually, then paste it in "Paste PEM" mode:',
      fetchNetworkError: 'crt.sh is unreachable (network restricted). Use the command below to fetch the certificate manually, then paste it in "Paste PEM" mode:',
      opensslHint: 'Run the following command in your terminal to get the PEM, then paste it in the "Paste PEM" tab:',
      noResult: 'No certificate records found for this domain',
      domainRequired: 'Please enter a domain name',
      noteTitle: 'Note',
      noteContent: 'Paste mode supports PEM format (-----BEGIN CERTIFICATE-----); Domain lookup fetches the latest certificate from crt.sh CT logs. If crt.sh is unreachable, use the openssl command shown in the error prompt to fetch the certificate manually.'
    },
    promptBox: {
      title: 'Prompt Toolkit',
      description: 'Built-in common Prompt templates with variable filling and custom management',
      searchPlaceholder: 'Search Prompts...',
      addPrompt: '+ New Prompt',
      noResult: 'No matching Prompts found',
      stats: 'Total {total} prompts (built-in {builtin} / custom {custom})',
      catAll: 'All',
      catCode: 'Code',
      catWriting: 'Writing',
      ...
      catCustom: 'Custom',
      fillVars: 'Fill Vars',
      fillVarsTitle: 'Fill Variables & Copy',
      promptContent: 'Prompt Preview',
      varPlaceholder: 'Enter {name}',
      copyFilled: 'Copy Result',
      copied: 'Copied to clipboard',
      ...
      contentPlaceholder: 'Enter prompt content, use double-brace variables (e.g. language, code) for replaceable parts, then click "Fill Vars" to fill them interactively',
    ...
    gitCommit: {
      ...
      description: 'Generate standardized commit messages following the Conventional Commits spec with a form-based interface',
      type: 'Commit Type',
      scope: 'Scope',
      scopePlaceholder: 'e.g. auth / ui / api (optional)',
      subject: 'Subject',
      subjectPlaceholder: 'Brief description of the change (max 72 chars)',
      subjectTooLong: 'Subject exceeds 72 characters',
      body: 'Body',
      bodyPlaceholder: 'Detailed description of the change (optional, multiline)',
      breaking: 'Breaking Change (BREAKING CHANGE)',
      breakingDesc: 'Breaking Change Description',
      breakingDescPlaceholder: 'Describe the breaking change (e.g. migration steps)',
      issues: 'Related Issues',
      issuesPlaceholder: 'e.g. #123, #456 (optional)',
      preview: 'Commit Preview',
      previewEmpty: 'Fill in the type and subject to generate a commit message...',
      copyFull: 'Copy Full Commit',
      copyTitle: 'Copy Title Only',
      copied: 'Copied to clipboard',
      history: 'Recent Commits',
      infoTitle: 'Usage Guide',
infoContent: 'Follows Conventional Commits: type(scope): subject. feat=new feature, fix=bug fix, docs=documentation, style=formatting, refactor=code refactor, perf=performance, test=tests, chore=build/tooling. Breaking changes append ! after the type.',
typeFeatDesc: 'New feature',
typeFixDesc: 'Bug fix',
typeDocsDesc: 'Documentation update',
typeStyleDesc: 'Code style (no logic change)',
typeRefactorDesc: 'Code refactor (not a fix or feature)',
typePerfDesc: 'Performance improvement',
typeTestDesc: 'Add or update tests',
typeChoreDesc: 'Build / tooling changes',
typeRevertDesc: 'Revert a commit',
typeBuildDesc: 'Build system / external deps',
typeCiDesc: 'CI configuration changes'
},
    mockData: {
      title: 'Mock Data Generator',
      description: 'Visually configure fields to quickly generate JSON mock data matching your business schema',
      count: 'Count',
      addField: 'Add Field',
      generate: 'Generate',
      copy: 'Copy',
      ...
      fieldNamePlaceholder: 'e.g. id / name / email',
      typeInt: 'Integer',
      typeFloat: 'Float',
      ...
      typeObject: 'Object',
      typeArray: 'Array',
      groupBasic: 'Basic Types',
      groupFaker: 'Fake Data',
      groupComplex: 'Complex Types',
      arrayItemType: 'Item Type',
      addChild: 'Add Child',
      enumOptions: 'Enum Values (comma-separated)',
      enumPlaceholder: 'e.g. active,inactive,pending',
      customTemplate: 'Template',
      customPlaceholder: 'e.g. user_{index}',
      intMin: 'Min',
      intMax: 'Max',
      floatDecimal: 'Decimal Places',
      resultTitle: 'Result',
      emptyFields: 'Please add at least one field',
      infoTitle: 'Usage Guide',
      infoContent: 'Add fields and choose a type. Object fields support nested child fields; Array fields let you set item type and count range. Enum supports a custom value list; Custom Template supports {index} (1-based), {uuid}, and {timestamp} placeholders. Click ▼ to collapse Object/Array fields. Export results as a JSON file.'
    }
  },
  custom: {
    title: 'Custom',
    scriptBox: {
      title: 'Script Toolkit',
      description: 'Write a JavaScript function, feed it input, and get the result instantly. Supports import/export of script collections',
      myScripts: 'My Scripts',
      newScript: 'New Script',
      noScripts: 'No scripts yet',
      selectOrCreate: 'Select a script or create one',
      scriptCode: 'Script Code',
      inputData: 'Input Data',
      inputPlaceholder: 'Enter input content, passed as the input argument (can be empty)',
      run: 'Run',
      output: 'Output',
      outputEmpty: 'Click "Run" to see the result',
      runTime: '{ms}ms',
      deleteConfirm: 'Delete this script?',
      export: 'Export Scripts',
      import: 'Import Scripts',
      exportSuccess: 'Exported successfully',
      importSuccess: 'Imported {count} scripts successfully',
      ...
      localStorageHint: 'Scripts are stored in browser localStorage. They will be lost if you clear cookies or browser data — export regularly to back up',
      codeHint1: 'The function must be named transform, accepting input and helpers parameters:',
      codeHint2: 'Return a string, object or any value. Supports async/await',
      helpersRef: 'Available helpers reference',
      helperDayjs: 'Date/time formatting and calculation',
      helperLodash: 'Full lodash-es methods',
      helperCryptoJS: 'MD5 / AES / SHA / HMAC encryption',
      helperYaml: 'YAML parse and stringify',
      helperMath: 'mathjs math library',
      helperUuid: 'Generate UUID v4',
      helperNanoid: 'Generate NanoID',
      helperDiff: 'Text diff comparison',
      helperMarked: 'Markdown to HTML',
      helperDOMPurify: 'XSS content sanitizer',
      helperXml: 'XML parser',
      helperSparkMD5: 'Large file MD5 hash',
      helperBuiltin: 'Browser native APIs, no import needed',
      helperCrypto: 'Web Crypto API, SHA/AES encrypt/decrypt',
      cat_text: 'Text',
      cat_json: 'JSON',
      cat_crypto: 'Crypto',
      ...
      cat_network: 'Network',
      cat_util: 'Utility',
      errorNoTransform: 'transform function not found. Make sure your code contains a named function called transform'
    }
  },
  composer: {
